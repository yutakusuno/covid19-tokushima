...
* [關於 good first issue 標籤](https://github.com/kagawa-metropolitan-gov/covid19/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) 是推薦給新手的。
...
對於提供貢獻的大家、在 [CONTRIBUTORS.md](https://github.com/kagawa-metropolitan-gov/covid19/blob/development/CONTRIBUTORS.md) 這份文件中記載了名字（暱稱）以及角色。
如果您有任何貢獻，請在此留下您的大名。
請在[#654](https://github.com/kagawa-metropolitan-gov/covid19/issues/654) 這個 Issue 留下您要公開的名字、連結（如果有的話）、角色。

## 開發相關的資訊
* 開發環境（Dev.）https://dev-covid19-kagawa.netlify.com/
* Stage 站 https://stg-covid19-kagawa.netlify.com/
* 正式環境 https://stopcovid19.metro.kagawa.lg.jp/
